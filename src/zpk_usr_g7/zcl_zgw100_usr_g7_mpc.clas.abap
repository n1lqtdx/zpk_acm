class ZCL_ZGW100_USR_G7_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZC_USR_G7TYPE.
      include type ZC_USR_G7.
  types:
    end of TS_ZC_USR_G7TYPE .
  types:
   TT_ZC_USR_G7TYPE type standard table of TS_ZC_USR_G7TYPE .

  constants GC_ZC_USR_G7TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZC_USR_G7Type' ##NO_TEXT.
...
CLASS ZCL_ZGW100_USR_G7_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW100_USR_G7_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250228160415'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20250228160416'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20250228160416'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZGW100_USR_G7' )
