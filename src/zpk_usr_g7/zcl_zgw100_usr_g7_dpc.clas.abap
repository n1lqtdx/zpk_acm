class ZCL_ZGW100_USR_G7_DPC definition
  public
...
protected section.
  ...
  methods ZC_USR_G7_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW100_USR_G7_MPC=>TS_ZC_USR_G7TYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_USR_G7_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods ZC_USR_G7_GET_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_USR_G7_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_USR_G7_MPC=>TT_ZC_USR_G7TYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_USR_G7_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_ZGW100_USR_G7_DPC IMPLEMENTATION.
...
*&* This class has been generated on 02/28/2025 17:04:17 in client 302
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_USR_G7_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zc_usr_g7_create_entity TYPE zcl_zgw100_usr_g7_mpc=>ts_zc_usr_g7type.
...
*     Call the entity set generated method
    zc_usr_g7_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = zc_usr_g7_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zc_usr_g7_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_usr_g7_get_entity TYPE zcl_zgw100_usr_g7_mpc=>ts_zc_usr_g7type.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zc_usr_g7_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_usr_g7_get_entity
                         es_response_context = es_response_context
          ).

        IF zc_usr_g7_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_usr_g7_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_USR_G7_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zc_usr_g7_get_entityset TYPE zcl_zgw100_usr_g7_mpc=>tt_zc_usr_g7type.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      zc_usr_g7_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zc_usr_g7_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zc_usr_g7_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_usr_g7_update_entity TYPE zcl_zgw100_usr_g7_mpc=>ts_zc_usr_g7type.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          zc_usr_g7_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_usr_g7_update_entity
          ).
       IF zc_usr_g7_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_usr_g7_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_ZC_USR_G7_1 TYPE zc_usr_g7 ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="" >| &
               | <sadl:dataSource type="CDS" name="ZC_USR_G7" binding="ZC_USR_G7" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="ZC_USR_G7" dataSource="ZC_USR_G7" maxEditMode="RO" exposure="TRUE" >| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20250228160416
               iv_uuid              = 'ZGW100_USR_G7'
               io_context           = me->mo_context ).
  endmethod.


  method ZC_USR_G7_CREATE_ENTITY.
  ...
  method ZC_USR_G7_UPDATE_ENTITY.
